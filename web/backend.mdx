...
This is where the programming logic lives. We’ll use **PHP** here. The backend covers the database, API routing, business logic, and more.
...
- **Non-relational** — No fixed schema; you insert data without defining structure upfront, often in an object/document form. Examples include MySQL.

### Setting up the database

- Download [Laragon](https://laragon.org/docs/install). Run the installer and accept the default settings.
- After installation, open the app and click **Start All**.
