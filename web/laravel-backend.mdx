...
![CRUD routes](../assets/backend/4.png)
...
![Laravel migrate](../assets/backend/6.png)
...
![Thunder Client](../assets/backend/5.png)
...
![GET books empty](../assets/backend/7.png)
