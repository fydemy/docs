...
![XAMPP Apache and MySQL](../assets/backend/backend_js/3.png)
...
![phpMyAdmin new database](../assets/backend/backend_js/4.jpg)
...
![API workflow](../assets/backend/backend_js/1.png)
...
![Prisma init](../assets/backend/backend_js/2.png)
...
![Prisma schema](../assets/backend/backend_js/5.png)
...
![Prisma migrate](../assets/backend/backend_js/8.png)

## Let's build the API

APIs often expose **CRUD** (Create, Read, Update, Delete) via different routes. For example:

![CRUD routes](../assets/backend/backend_js/6.png)
...
![Thunder Client](../assets/backend/backend_js/7.png)
...
![Prisma autocomplete](../assets/backend/backend_js/9.png)
...
![GET books empty](../assets/backend/backend_js/10.png)
